...
int protocol_set_mode(protocol_analyze_interface* interface,unsigned char* sources){
    ...
    if(m_ad_modle_set->m_handle.cmd == 0x31)//���ݔ��
    {
        DA_VI_SEL = 0;
        m_amplitude_tag = -50;
    }else if(m_ad_modle_set->m_handle.cmd == 0x32)//늉���ݔ��
    {
        DA_VI_SEL = 1;
        m_amplitude_tag = 1;
    }else
    ...
    case 0x01://���ǲ�
          ...
          m_double = fabs(m_amplitude*m_amplitude_tag/1000);//��ѹģʽ�£�value = Ŀ���ѹ��V��������ģʽ��value = -50 * Ŀ�������A��
    ...
    case 0x04://ֱ��
        WAVE_SEL = 1; //fix_wave
        m_double = m_amplitude*m_amplitude_tag/1000;//��ѹģʽ�£�value = Ŀ���ѹ��V��������ģʽ��value = -50 * Ŀ�������A��
        p_float=( unsigned char *)&m_double;
